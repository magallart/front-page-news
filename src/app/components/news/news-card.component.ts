  ...
  template: `
    ...
    >
      ...
      <div class="flex h-full flex-col gap-3 p-4 pl-5">
        ...
        <h3 class="font-editorial-title text-xl font-semibold leading-7 tracking-[0.01em]">
          <button
            type="button"
            class="title-clamp block w-full text-left underline decoration-2 decoration-transparent underline-offset-4 hover:decoration-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            (click)="onPreviewRequest($event)"
          >
            {{ article().title }}
          </button>
